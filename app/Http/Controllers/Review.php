...
class Review extends Controller
{
    ...
    private function _format_actions($row){
        return '<a class="btn-popup-form btn waves-effect p-0 ms-1" data-url="'.route('review.edit', $row['reviewId']).'"><i class="feather icon-file-text"></i></a> <a class="btn-popup-form btn waves-effect p-0 ms-1" data-url="'.route('review.edit', $row['reviewId']).'"><i class="feather icon-trash text-danger"></i></a>';
    }
}
