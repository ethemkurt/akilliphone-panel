                ...
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-bs-toggle="pill" href="#home"
                            aria-expanded="true">Kategori Tanımları</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="home" aria-labelledby="home-tab"
                        ...
                        <form>
                            ...
                            <div class="mb-1">
                                <x-inputs.text-input name="product_name" label="Listeleme Sıra No"
                                    placeholder="GaN Lite Quick Charger" />
                            </div>
                            <div class="mb-1">
                                <x-inputs.text-input name="product_name" label="Kategori Kodu"
                                    placeholder="GaN Lite Quick Charger" />
                            </div>
                            <div class="mb-1">
                            ...
                            @endphp
                            <div class="mb-1">
                                <x-inputs.select-input :items="$sarki" label="Üst Kategori" name="sarki" />
                            </div>
                            <div class="mb-1">
                                <x-inputs.text-input name="product_name" label="Seo Url"
                                    placeholder="GaN Lite Quick Charger" />
                            </div>
                            @php
                            $amazon = [
                        ...
                        @endphp
                        <div class="mb-1">
                            <x-inputs.select-input :items="$amazon" label="Amazon Kategorisi" name="sarki" />
                        </div>
                        <div class="mb-1">
                            <x-inputs.text-input name="product_name" label="Google Kategorisi"
                                placeholder="GaN Lite Quick Charger" />
                        </div>
                        <div class="mb-1">
                            <x-inputs.text-input name="product_name" label="Menu CSS Sınıfı"
                                placeholder="GaN Lite Quick Charger" />
                        </div>
                        <div class="mb-1" id="full-wrapper">
                          ...
                          <div class="mb-1">
                            <x-inputs.text-input name="product_name" label="Ana Sayfa"
                                placeholder="Tab Listesinde Görünme Sırası '0' ve 'Boş' Olursa Görünmez" />
                        </div>
                        <div class="mb-1">
