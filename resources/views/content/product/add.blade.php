    ...
    <div class="card mb-4">
      <div class="card-body">
        <ul class="nav nav-pills">
            <li class="nav-item">
              <a class="nav-link active" id="home-tab" data-bs-toggle="pill" href="#home" aria-expanded="true">Genel Tanımlar</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" id="about-tab" data-bs-toggle="pill" href="#about" aria-expanded="false">Detaylar</a>
            </li>
          </ul>
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home" aria-labelledby="home-tab" aria-expanded="true">
                <form id="jquery-val-form" method="post">
                    ...
                    <x-inputs.text-input name="product_name" label="Text Input" placeholder="GaN Lite Quick Charger" />
                    <x-inputs.email-input name="email_input" label="Email Input" placeholder="john.doe@gmail.com" />
                    ...
                    <x-inputs.text-field name="validation:D" label="Text Field" rows="6" />
                    <div class="mb-1">
                        <x-inputs.checkbox-input label="Agree to our terms and conditions" name="terms_and_conditions" />
                    </div>
